...
ui <- fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            HTML("<h3> Prop 18:  </h3> <br/> A yes vote supports this constitutional amendment to allow 17-year-olds who will be 18 at the time of the next general election to vote in primary elections and special elections. <br/> <br/>

A no vote opposes this constitutional amendment, thereby continuing to prohibit 17-year-olds who will be 18 at the time of the next general election to vote in primary elections and special elections. <br/> <br/>

A number of states have passed a similar law to this one. We examine political lean for each of these states in presidential and senatorial elections before and after passage of this amendment. We hypothesize that a yes vote does not affect enough new voters to create an appreciable change in political partisan makeup. <br/> <br/>
"),
            selectInput("state",
        ...
        mainPanel(
            tabsetPanel(
                ...
                tabPanel("Significance Tests",
                         ...
                         verbatimTextOutput('sensum'), # T-test of Senate Race Lean Pre and Post Enactment Year
                         HTML("<h4> President T-Test results comparing pre and post enactment leans: </h4>"),
                         verbatimTextOutput('pressum'), # T-test of Presidential Race Lean Pre and Post Enactment Year
...
server <- function(input, output, session) {
    ...
    # Reactive input creating a subset of senate data set
